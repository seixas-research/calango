    ...
    const KpointsConvergenceRunConfig& config)
{
    ...
    out << "#!/usr/bin/env python3\n"
        ...
        << AseScriptGenerator::gpawImports(config.calculator)
        << "\n"
    ...
    out << "]\n"
        ...
        << "\")\n"
           ...
           "    \"\"\"Bind a fresh GPAW calculator at one k-point mesh.\n"
           "\n"
           ...
           "    \"\"\"\n"
           "    atoms.calc = GPAW(\n";
    if (config.calculator.gpawGammaCentered)
        out << "        # Γ-centred, as configured — held across the sweep.\n"
    ...
    out << "        txt=f\"gpaw_kpts_{kpts[0]}x{kpts[1]}x{kpts[2]}.out\",\n"
           "    )\n"
           "\n"
           "\n"
           "points = []\n"
