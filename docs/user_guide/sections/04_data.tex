...
\begin{description}
  \item[\menu{File}\menusep\menu{Save}\menusep\menu{Structure As}]
    ...
    The format follows the extension you type.
...
\begin{caltip}
Extended XYZ round-trips more than plain XYZ --- cell, periodicity and
per-atom arrays all survive. When in doubt, save \file{.extxyz}.
\end{caltip}
