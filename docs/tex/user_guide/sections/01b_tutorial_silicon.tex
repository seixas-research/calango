...
Electronic Structure, Optics, ELF, MLWF and GW all load a completed ground
...
\begin{itemize}
  ...
  \item \menu{Simulation}\menusep\menu{Electron Localization Function (ELF)\dots}
    --- the covalent bond charge between neighbours, as an isosurface.
