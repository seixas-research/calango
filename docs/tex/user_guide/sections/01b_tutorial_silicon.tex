...
Electronic Structure, Optics, Wannier Functions, GW and the charge density difference all
...
\begin{itemize}
  ...
  \item \menu{Wannier Functions}\menusep\menu{Calculate Wannier Functions\dots} --- the four
    $sp^3$ bond orbitals of the diamond lattice.
