...
\kbd{Ctrl}+\kbd{R} & New calculation \\
\kbd{Ctrl}+\kbd{Shift}+\kbd{R} & New remote calculation \\
\bottomrule
\end{tabular}
\end{center}
...
\texttt{paramiko}     & Remote Access panel \\
...
\begin{description}
  ...
  \item[The remote panel reports a connection failure.]
    ...
    terminal first. Remember that the passphrase field doubles as the key
    passphrase in \ui{SSH key} mode.
