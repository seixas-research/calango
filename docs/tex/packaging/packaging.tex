...
\vfill
{\large July 2026 --- Calango 26.7.55\par}
\vspace*{1.2cm}
\end{titlepage}
...
\file{calango-26.7.55-macos-arm64.dmg} \\
Linux & \opt{DEB} & \file{calango\_26.7.55\_amd64.deb} \\
\bottomrule
\end{tabular}
\end{center}
...
The result is \file{build-dmg/calango-26.7.55-macos-arm64.dmg}. Mounting
...
\begin{lstlisting}
APP=_CPack_Packages/Darwin/DragNDrop/calango-26.7.55-macos-arm64/calango.app
...
hdiutil attach -readonly -nobrowse calango-26.7.55-macos-arm64.dmg
\end{lstlisting}
...
The result is \file{calango\_26.7.55\_<arch>.deb}. Install it via
\opt{apt} rather than \opt{dpkg -i}, so the dependencies are resolved:

\begin{lstlisting}
sudo apt install ./calango_26.7.55_amd64.deb
\end{lstlisting}
...
\begin{lstlisting}
dpkg-deb --info  calango_26.7.55_amd64.deb   # control fields, Depends
dpkg-deb --contents calango_26.7.55_amd64.deb
